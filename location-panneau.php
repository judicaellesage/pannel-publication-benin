...
$request_panneau = "SELECT * FROM location_panneau";
$query_panneau = mysqli_query($immo, $request_panneau);
...
<head>
    ...
    <!-- Title -->
    <title>Location panneau | Pannel</title>
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Location panneau publicitaire</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom position-relative">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <?php 
                            foreach ($query_panneau as $value) {
                            ?>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            ...
                                            <span class="d-block fs-5 text-body">location panneau</span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td><?php echo $value['code_panneau']; ?></td>
                                <td>
                                    <span class="legend-indicator bg-success"></span><?php echo $value['date_debut']; ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td><a href="detail-location.php?details=<?php echo $value['id']; ?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
