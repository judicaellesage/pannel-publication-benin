                ...
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuDashboards"
                            role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards"
                    ...
                    <div id="navbarVerticalMenuPagesMenu">
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUsersMenu"
                                ...
                                <span class="nav-link-title">Biens immeubles</span>
                            </a>

                            <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                <a class="nav-link " href="achat-bien-immeuble.php">Achat de bien immeuble</a>
                                <a class="nav-link " href="bon-commande.php">Bon de commande</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUserProfileMenu"
                                ...
                                <span class="nav-link-title">Suivi des requêtes</span>
                            </a>

                            <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                <a class="nav-link " href="suivi-achat-bien.php">Achat de bien immeuble</a>
                                <a class="nav-link " href="vente-bien-immeuble.php">Vente de bien immeuble</a>
                                <a class="nav-link " href="btp-construction.php">Services BTP - Construction</a>
                                <a class="nav-link " href="location-panneau.php">Location de panneaux publicitaires</a>
                                <a class="nav-link " href="#">Location des appartements meublés</a>
                                <a class="nav-link " href="#">Services contrôle qualité</a>
                                <a class="nav-link " href="#">Services entretiens</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesAccountMenu"
                                ...
                                <span class="nav-link-title">Exploitation agricole</span>
                            </a>

                            <div id="navbarVerticalMenuPagesAccountMenu" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                <a class="nav-link " href="#">Achats de produits tropicaux et vivriers</a>
                                <a class="nav-link " href="#">Plantation et entretien</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
