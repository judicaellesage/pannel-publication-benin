...
if (isset($_POST['ajouter'])) {
    ...
    if (isset($_FILES['photo']) AND $_FILES['photo']['error'][0] == 0) {
        ...
        $infosfichier = pathinfo($_FILES['photo']['name'][0]);
        ...
        $nomvrai_a = $nomvrai.'.'.$extension_upload;

        /* $_FILES['address']['name'] = $nomvrai_a;*/
        $extensions_autorisees = array('jpg', 'jpeg', 'png');

        if (in_array($extension_upload, $extensions_autorisees)) {
            
            // On peut valider le fichier et le stocker définitivement
            move_uploaded_file($_FILES['photo']['tmp_name'][0], 'images/' . basename($nomvrai_a));

        }
    }

    /*traitement de la photo 2*/
    if (isset($_FILES['photo']) AND $_FILES['photo']['error'][1] == 0) {

        $unique_id = time();
        
        $infosfichier = pathinfo($_FILES['photo']['name'][1]);
        $extension_upload = $infosfichier['extension'];
        ...
        $nomvrai_b = $nomvrai.'.'.$extension_upload;
        ...
        if (in_array($extension_upload, $extensions_autorisees)) {
            ...
            // On peut valider le fichier et le stocker définitivement
            move_uploaded_file($_FILES['photo']['tmp_name'][1], 'images/' . basename($nomvrai_b));

        }
    }

    /*traitement de la photo 3*/
    if (isset($_FILES['photo']) AND $_FILES['photo']['error'][2] == 0) {

        $unique_id = time();
        
        $infosfichier = pathinfo($_FILES['photo']['name'][2]);
        $extension_upload = $infosfichier['extension'];
        ...
        $nomvrai_c = $nomvrai.'.'.$extension_upload;
        ...
        if (in_array($extension_upload, $extensions_autorisees)) {
            ...
            // On peut valider le fichier et le stocker définitivement
            move_uploaded_file($_FILES['photo']['tmp_name'][2], 'images/' . basename($nomvrai_c));

        }
    }

    /*traitement de la photo 1*/
    if (isset($_FILES['photo']) AND $_FILES['photo']['error'][3] == 0) {

        $unique_id = time();
        
        $infosfichier = pathinfo($_FILES['photo']['name'][3]);
        $extension_upload = $infosfichier['extension'];
        ...
        $nomvrai_d = $nomvrai.'.'.$extension_upload;
        ...
        if (in_array($extension_upload, $extensions_autorisees)) {
            ...
            // On peut valider le fichier et le stocker définitivement
            move_uploaded_file($_FILES['photo']['tmp_name'][3], 'images/' . basename($nomvrai_d));
    ...
    $request_ajout_achat_bien = "INSERT INTO `achat_bien_immeuble` (`id`, `code`, `prix`, `description`,`superficie`, `commune`, `arrondissement`, `photo_1`, `photo_2`, `photo_3`, `photo_localisation`, `status`, `date_publication`) VALUES (NULL, '$code', '$prix', '$description','$superficie', '$commune', '$arrondissement', '$nomvrai_a', '$nomvrai_b', '$nomvrai_c', '$nomvrai_d', 'en cours', '$date_publication')";
    $query_ajout_achat_bien = mysqli_query($immo, $request_ajout_achat_bien);

    if ($query_ajout_achat_bien) {
        header('Location: achat-bien-immeuble.php');
        exit();
    }
...
<head>
    ...
    <!-- Title -->
    <title>Ajouter un achat | Pannel</title>
            ...
            <!-- Content Step Form -->
                <div id="addUserStepFormContent">
                    <div style="text-align: center;">
                        <h3>Ajouter un bien immeuble</h3>
                    </div>
                    <!-- Card -->
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <!-- Form -->
                            <div class="row mb-4">
                                <label for="code" class="col-sm-3 col-form-label form-label">Code du bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code" id="code"
                                        placeholder="Code du bien" aria-label="Code du bien" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="prix" class="col-sm-3 col-form-label form-label">Prix du bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="prix" id="prix"
                                        placeholder="Prix du bien" aria-label="Prix du bien" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Superficie</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                        placeholder="Superficie" aria-label="Superficie" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="commune" class="col-sm-3 col-form-label form-label">Commune</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="commune" id="commune"
                                        placeholder="Commune" aria-label="Commune" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="arrondissement" class="col-sm-3 col-form-label form-label">Arrondissement</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="arrondissement" id="arrondissement"
                                        placeholder="Arrondissement" aria-label="Arrondissement" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="photo_1" class="col-sm-3 col-form-label form-label">Photo 1</label>

                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="photo[]" id="photo_1"
                                        placeholder="Photo 1" aria-label="Photo 1" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="photo_2" class="col-sm-3 col-form-label form-label">Photo 2</label>

                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="photo[]" id="photo_2"
                                        placeholder="Photo 2" aria-label="Photo 2" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="photo_3" class="col-sm-3 col-form-label form-label">Photo 3</label>

                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="photo[]" id="photo_3"
                                        placeholder="Photo 3" aria-label="Photo 3" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="photo_4" class="col-sm-3 col-form-label form-label">Photo localisation</label>

                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="photo[]" id="photo_4"
                                        placeholder="Photo localisation" aria-label="Photo localisation" required>
                                </div>
                            </div>
                            <!-- End Form -->
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-end align-items-center">
                            <button type="submit" class="btn btn-primary" name="ajouter">
                                Ajouter <i class="bi-chevron-right"></i>
                            </button>
                        </div>
                        <!-- End Footer -->
                    </div>
