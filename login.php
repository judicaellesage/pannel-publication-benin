...
if (isset($_POST['login'])) {
    ...
    $request_login = "SELECT * FROM admin WHERE email = '$email' AND password = '$password'";
    $query_login = mysqli_query($immo, $request_login);
    $login = mysqli_fetch_assoc($query_login);

    if ($login != 0) {

        $_SESSION['connected'] = (boolean) true;
                        ...
                        <form method="post" action="">
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <p>Vous n'avez pas de compte? <a class="link"
                                            href="#">Contactez votre administrateur</a></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control form-control-lg" name="email" id="signinSrEmail"
                                    ...
                                    required>
                                <span class="invalid-feedback">Entrez une adresse email valide.</span>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                        name="password" id="signupSrPassword" placeholder="Entrez votre mot de passe"
                           ...
                           "classChangeTarget": "#changePassIcon"
                            ...
                            <div class="d-grid">
                                <button type="submit" name="login" class="btn btn-primary btn-lg">Connexion</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
