...
<head>
    ...
    <!-- Title -->
    <title>Suivi d'achat de bien immeuble | Pannel</title>
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Suivi d'achat de bien immeuble</h1>
                    </div>
                    <!-- End Col -->
            ...
            <div class="card">
                        ...
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control"
                                    placeholder="Rechercher" aria-label="Search users">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                ...
                <div class="table-responsive datatable-custom position-relative">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <?php 
                            foreach ($query_list_suivi_achat as $value) {
                            ?>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            ...
                                            <span class="d-block fs-5 text-body">suivi achat </span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td><?php echo $value['code_bien']; ?></td>
                                <td>
                                    <span class="legend-indicator bg-success"></span><?php echo $value['status']; ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td><a href="details-suivi-achat.php?details=<?php echo $value['code_bien']; ?>&id=<?php echo $value['id']; ?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
