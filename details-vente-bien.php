...
/*recuperer les informations du bien*/
if (isset($_GET['details'])) {
    $details = $_GET['details'];

    /*get infos about bon*/
    $request_details_vente = "SELECT * FROM vente_bien WHERE id = '$details'";
    $query_details_vente = mysqli_query($immo, $request_details_vente);
    $vente = mysqli_fetch_assoc($query_details_vente);

}else {
    header('Location: bon-commande.php');
    exit();
}
...
<head>
    ...
    <!-- Title -->
    <title> Détail de bon de commande | Pannel</title>
            ...
            <!-- Content Step Form -->
                <div id="addUserStepFormContent">
                    <div style="text-align: center;">
                        <h3>Détails de vente de bien immeuble</h3>
                    </div>
                    <!-- Card -->
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                                <!-- Form -->
                            <div class="row mb-4">
                                <label for="code" class="col-sm-3 col-form-label form-label">Nom et prénom</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code"  aria-label="Code du bien" value="<?php echo $vente['nom']." ".$vente['prenom']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="description" class="col-sm-3 col-form-label form-label">Telephone</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="description" id="description"
                                    aria-label="Code du bien" value="<?php echo $vente['telephone']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="commune" class="col-sm-3 col-form-label form-label">S'agit il d'un bon de commande?</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="commune" id="commune"
                                        value="<?php echo $vente['bon_commande'] ?>" aria-label="Commune" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="arrondissement" class="col-sm-3 col-form-label form-label">Titre </label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="arrondissement" id="arrondissement"
                                         aria-label="Arrondissement" value="<?php echo $vente['titre']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="ville" class="col-sm-3 col-form-label form-label">Lieu de résidence</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ville" id="ville"
                                        aria-label="Ville" value="<?php echo $vente['lieu_residence']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Le type de propriété</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['type_propriete']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Superficie du bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['superficie_bien']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Baffon à proximité du bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['baffon']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Fétiche sur le bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['fetiche']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Litige dans la zone</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['litige_zone']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Electricité disponible</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['electricite']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Distance du bien du goudron</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['distance_voie']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Largeur de la voie</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['largeur_voie']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">La distance de la voie</label>
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Accès du bien à moto</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['acces_moto']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Accès du bien avec voiture</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['acces_voiture']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Prix de vente</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['prix_vente']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Prix de négociation</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['negociation']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Contact prpriétaire</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['contact_proprio']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Numéro du chef de quartier</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['numero_cq']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Nom chef quartier</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['nom_cq']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Informations supplémentaire</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['information_sup']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Pièces du bien</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $vente['pieces_bien']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="status" name="status">
                                            <option value="en cours">0 - en cours</option>
                                            <option value="traiter">1 - traiter</option>
                                            <option value="annuler">2 - traiter</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- End Form -->
                        ...
                        <div class="card-footer d-flex justify-content-end align-items-center">
                            <button type="submit" class="btn btn-primary" name="update">
                                Mise à jour <i class="bi-chevron-right"></i>
                            </button>
                        </div>
                        <!-- End Footer -->
                        </form>
    ...
    <!-- End Row -->
        ...
        <div class="footer">
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <p class="fs-6 mb-0">&copy; Front. <span class="d-none d-sm-inline-block">2022 Pannel.</span>
                    </p>
                </div>
                <!-- End Col -->
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="hs-has-sub-menu nav-item">
                                    <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle "
                                        href="#" role="button"><i class="bi-files-alt dropdown-item-icon"></i> Pages</a>
                                ...
                                <!-- Apps -->
                                <li class="hs-has-sub-menu nav-item">
                                    <a id="appsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="#"
                                        role="button"><i class="bi-app-indicator dropdown-item-icon"></i> Apps</a>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users-add-user.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Nov 2022 20:58:42 GMT -->
