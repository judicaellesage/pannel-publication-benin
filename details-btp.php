...
if (isset($_GET['details'])) {
    ...
    /*get infos about bon*/
    $request_details = "SELECT * FROM btp WHERE id = '$details'";
    $query_details = mysqli_query($immo, $request_details);
    $btp = mysqli_fetch_assoc($query_details);

}else {
    header('Location: btp-construction.php');
    exit();
}
...
<head>
    ...
    <!-- Title -->
    <title> Détail construction | Pannel</title>
                ...
                <div id="addUserStepFormContent">
                    ...
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                                <!-- Form -->
                            <div class="row mb-4">
                                <label for="code" class="col-sm-3 col-form-label form-label">Nom</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code"  aria-label="Code du bien" value="<?php echo $btp['nom']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="description" class="col-sm-3 col-form-label form-label">Prénom</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="description" id="description"
                                    aria-label="Code du bien" value="<?php echo $btp['prenom']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="commune" class="col-sm-3 col-form-label form-label">Téléphone</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="commune" id="commune"
                                        value="<?php echo $btp['telephone'] ?>" aria-label="Commune" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="arrondissement" class="col-sm-3 col-form-label form-label">Lieu de construction</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="arrondissement" id="arrondissement"
                                         aria-label="Arrondissement" value="<?php echo $btp['lieu_construction']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="ville" class="col-sm-3 col-form-label form-label">Titre de propriété</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ville" id="ville"
                                        aria-label="Ville" value="<?php echo $btp['type_propriete']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Permis de construction</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $btp['permis_construction']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Devis</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $btp['devis']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Plan de construction</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $btp['plan']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Etude de sol</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $btp['etude_sol']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Date de démarrage</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $btp['date_demarrage']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="annuler">2 - annuler</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- End Form -->
