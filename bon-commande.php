...
<head>
    ...
    <!-- Title -->
    <title>Bon de commande | Pannel</title>
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Bon de commande</h1>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="ajout-bon-commande.php">
                            <i class="bi-person-plus-fill me-1"></i> Ajouter un bon
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Code du bon</th>
                                <th>Superficie</th>
                                <th>Ville</th>
                                <th>Commune</th>
                                <th>Status</th>
                        ...
                        <tbody>
                            <?php 
                            foreach ($query_list_bon_commande as $value) {
                            ?>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            ...
                                            <span class="d-block fs-5 text-body">bon de commande</span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <span class="d-block h5 mb-0"><?php echo $value['superficie']; ?></span>
                                ...
                                <td><a href="details-bon-commande.php?details=<?php echo $value['id']; ?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
