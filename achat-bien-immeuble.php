...
require "controller/bienController.php";
require "controller/controller.php";

/*compter les differents nombre pour les status*/

/*status total*/
$request_total = "SELECT COUNT(*) AS nombre_total FROM achat_bien_immeuble";
$query_total = mysqli_query($immo, $request_total);
$total = mysqli_fetch_assoc($query_total);

/*status en cours*/
$request_status_en_cours = "SELECT COUNT(*) AS nombre_en_cours FROM achat_bien_immeuble WHERE status = 'en cours'";
$query_status_en_cours = mysqli_query($immo, $request_status_en_cours);
$status_en_cours = mysqli_fetch_assoc($query_status_en_cours);

/*status valider*/
$request_status_valider = "SELECT COUNT(*) AS nombre_valider FROM achat_bien_immeuble WHERE status = 'valider'";
$query_status_valider = mysqli_query($immo, $request_status_valider);
$status_valider = mysqli_fetch_assoc($query_status_valider);

/*status annuler*/
$request_status_annuler = "SELECT COUNT(*) AS nombre_annuler FROM achat_bien_immeuble WHERE status = 'annuler'";
$query_status_annuler = mysqli_query($immo, $request_status_annuler);
$status_annuler = mysqli_fetch_assoc($query_status_annuler);
...
<head>
    ...
    <!-- Title -->
    <title>Achat de bien immeuble | Pannel</title>
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item active" aria-current="page">Bien immeuble</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Achat de bien immeuble</h1>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="ajout-achat-bien-immeuble.php">
                            <i class="bi-person-plus-fill me-1"></i> Ajouter un achat
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Total achat</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span
                                        class="js-counter display-4 text-dark"><?php echo $total['nombre_total']; ?></span>
                                </div>
                                <!-- End Col -->
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span
                                        class="js-counter display-4 text-dark"><?php echo $status_en_cours['nombre_en_cours']; ?></span>
                                </div>
                            </div>
                            <!-- End Row -->
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Valider</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span
                                        class="js-counter display-4 text-dark"><?php echo $status_valider['nombre_valider']; ?></span>
                                </div>
                            </div>
                            <!-- End Row -->
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Annuler</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span
                                        class="js-counter display-4 text-dark"><?php echo $status_annuler['nombre_annuler']; ?></span>
                                </div>
                        ...
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control"
                                    placeholder="Rechercher un achat" aria-label="Search users">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                    ...
                    <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn btn-white btn-sm dropdown-toggle w-100"
                                ...
                                <i class="bi-download me-2"></i> Exportez
                            </button>

                            <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="usersExportDropdown">
                                <div class="dropdown-divider"></div>
                                <span class="dropdown-header">Options de téléchargements</span>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Code du bien</th>
                                <th>Prix du bien</th>
                                <th>Superficie</th>
                                <th>Commune</th>
                        ...
                        <tbody>
                            <?php 
                            foreach ($query_list_achat_bien as $value) {
                            ?>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0"><?php echo $value['code']; ?> <i
                                                    class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Top endorsed"></i></span>
                                            <span class="d-block fs-5 text-body">achat bien immeuble</span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <span class="d-block h5 mb-0"><?php echo $value['prix']; ?></span>
                                    <span class="d-block fs-5">F CFA</span>
                                </td>
                                <td><?php echo $value['superficie']; ?></td>
                                <td>
                                    <span class="legend-indicator bg-success"></span><?php echo $value['commune']; ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fs-5 me-2"><?php echo $value['arrondissement']; ?></span>
                                    </div>
                                </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="js-nav-scroller hs-nav-scroller-horizontal">
                        ...
                        <ul class="js-tabs-to-dropdown nav nav-segment nav-fill mb-5" id="editUserModalTab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#change-password" id="change-password-tab"
                                    data-bs-toggle="tab" data-bs-target="#change-password" role="tab"
                                    aria-selected="false">
                                    <i class="bi-shield-lock me-1"></i> Change password
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#notifications" id="notifications-tab" data-bs-toggle="tab"
                                    data-bs-target="#notifications" role="tab" aria-selected="false">
                        ...
                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                            ...
                            <form>
                              ...
                              "allowTypes": [".png", ".jpeg", ".jpg"]
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="editFirstNameModalLabel" class="col-sm-3 col-form-label form-label">Full
                                        name <i class="tio-help-outlined text-body ms-1" data-bs-toggle="tooltip"
                                 ...
                                 "template": "+0(000)000-00-00"
                                            ...
                                            <div class="tom-select-custom">
                                                <select class="js-select form-select" autocomplete="off"
                                                    name="editPhoneSelect" data-hs-tom-select-options='{
                                  "searchInDropdown": false,
                                  "hideSearch": true
                                }'>
                               ...
                               "placeholder": "Select country"
                                        ...
                                        <div class="mb-4">
                                            <input type="text" class="form-control" name="editCityModal"
                                                id="editCityModalLabel" placeholder="City" aria-label="City"
                                                value="London">
                                        </div>

                                        <input type="text" class="form-control" name="editStateModal"
                                            id="editStateModalLabel" placeholder="State" aria-label="State">
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="addressLine1"
                                            id="editAddressLine1Label" placeholder="Your address"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="editAddressLine2Modal"
                                            id="editAddressLine2ModalLabel" placeholder="Your address"
                                ...
                                <!-- Form -->
                                <div class="row">
                                    <label for="editZipCodeLabel" class="col-sm-3 col-form-label form-label">Zip code <i
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="js-input-mask form-control" name="zipCode"
                                            id="editZipCodeLabel" placeholder="Your zip code" aria-label="Your zip code"
                                            value="KW5 8NW" data-hs-mask-options='{
                             "mask": "AA0 0AA"
                           }'>
                                    </div>
                                </div>
                                    ...
                                    <label class="row form-check form-switch"
                                        ...
                                        <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input"
                                                id="editUserModalBillingPreferencesSwitch1" checked>
                                        </span>
                                    </label>
                                    <!-- End Form Switch -->
                                    ...
                                    <label class="row form-check form-switch"
                                        ...
                                        <span class="col-8 col-sm-9 ms-0">
                                            <span class="d-block text-dark mb-1">See info about people who view my
                                                profile</span>
                                            <span class="d-block fs-5 text-muted"><a class="link" href="#">More about
                                                    viewer info</a>.</span>
                                        </span>
                                        <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="js-toggle-password form-control"
                                            ...
                                            aria-label="Confirm your new password" data-hs-toggle-password-options='{
                               "target": "#editUserModalChangePassModalCheckbox"
                             }'>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="notifications" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <span class="d-block mb-2">Send a daily summary ("Daily Digest") of task
                                            activity.</span>
                            ...
                            <p>In order to cut back on noise, email notifications are grouped together and only sent
                                when you're idle or offline.</p>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Nov 2022 20:58:39 GMT -->
