...
require "controller/suiviController.php";
...
<head>
    ...
    <!-- Title -->
    <title>Vente de bien immeuble | Pannel</title>
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item active" aria-current="page">Suivi requête</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Vente de bien immeuble</h1>
                    </div>
                    <!-- End Col -->
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom position-relative">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <?php 
                            foreach ($query_list_vente as $value) {
                            ?>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            ...
                                            <span class="d-block fs-5 text-body">vente de bien</span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td><?php echo $value['lieu_residence']; ?></td>
                                <td>
                                    <span class="legend-indicator bg-success"></span><?php echo $value['type_propriete']; ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td><?php echo $value['nature_bien']; ?></td>
                                <td><a href="details-vente-bien.php?details=<?php echo $value['id']; ?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
