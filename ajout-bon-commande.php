...
if (isset($_POST['ajouter'])) {
    ...
    $request_ajout_bon_commande = "INSERT INTO `bon_commande` (`id`, `code`, `description`, `commune`, `arrondissement`, `ville`, `superficie`, `budget`,`status`, `date_publication`) VALUES (NULL, '$code', '$description', '$commune', '$arrondissement', '$ville', '$superficie', '$budget','en cours', '$date_publication')";
    $query_ajout_bon_commande = mysqli_query($immo, $request_ajout_bon_commande);

    if ($query_ajout_bon_commande) {
...
<head>
    ...
    <!-- Title -->
    <title>Ajouter un bon | Pannel</title>
            ...
            <!-- Content Step Form -->
                <div id="addUserStepFormContent">
                    <div style="text-align: center;">
                        <h3>Ajouter un bon de commande</h3>
                    </div>
                    <!-- Card -->
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <!-- Form -->
                            <div class="row mb-4">
                                <label for="code" class="col-sm-3 col-form-label form-label">Code du bon</label>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="description" id="description"
                                        placeholder="description du bon" aria-label="Code du bien" required>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="ville" class="col-sm-3 col-form-label form-label">Ville</label>
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="budget" class="col-sm-3 col-form-label form-label">Budget</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="budget" id="budget"
                                        placeholder="budget" aria-label="Superficie" required>
                                </div>
                            </div>
                            <!-- End Form -->
