...
if (isset($_GET['details'])) {
    ...
    /*get infos about bon*/
    $request_details = "SELECT * FROM bon_commande WHERE id = '$details'";
    $query_details = mysqli_query($immo, $request_details);
    $bon = mysqli_fetch_assoc($query_details);
            ...
            <!-- Content Step Form -->
                <div id="addUserStepFormContent">
                    <div style="text-align: center;">
                        <h3>Détails de bon de commande</h3>
                    </div>
                    <!-- Card -->
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code"  aria-label="Code du bien" value="<?php echo $bon['code']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    aria-label="Code du bien" value="<?php echo $bon['description']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="commune" id="commune"
                                        value="<?php echo $bon['commune'] ?>" aria-label="Commune" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="arrondissement" id="arrondissement"
                                         aria-label="Arrondissement" value="<?php echo $bon['arrondissement']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ville" id="ville"
                                        aria-label="Ville" value="<?php echo $bon['ville']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $bon['superficie']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
