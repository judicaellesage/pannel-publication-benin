...
if (isset($_GET['details'])) {
    ...
    $request_client = "SELECT * FROM suivi_achat_bien WHERE id = '$id'";
    $query_client = mysqli_query($immo, $request_client);
    $client = mysqli_fetch_assoc($query_client);

    /*recuperer les informations du bien*/
    $request_bien = "SELECT * FROM achat_bien_immeuble WHERE code = '$details'";
    $query_bien = mysqli_query($immo, $request_bien);
    $bien = mysqli_fetch_assoc($query_bien);

}else {
	header('Location: suivi-achat-bien.php');
	exit();
}
...
<head>
    ...
    <!-- Title -->
    <title>Details suivi achat | Pannel</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Details suivi achat</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-header">
                            <h4 class="card-header-title">Information client</h4>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Nom <i
                                ...
                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $client['nom']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->

                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Prénom <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $client['prenom']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Téléphone <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $client['telephone']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                        </div>
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Code <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['code']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Prix <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['prix']." F CFA"; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Description <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['description']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Superficie<i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['superficie']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Commune <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['commune']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="productNameLabel" class="form-label">Arrondissement <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="Products are the goods or services you sell."></i></label>

                                <input type="text" class="form-control" name="productName" id="productNameLabel"
                                     aria-label="Shirt, t-shirts, etc." value="<?php echo $bien['arrondissement']; ?>" 
                                    value="Tiro track jacket" disabled>
                            </div>
                            <!-- End Form -->
                            <!-- Gallery -->
                            <div id="fancyboxGallery" class="js-fancybox row justify-content-sm-center gx-3">
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="images/<?php echo $bien['photo_1']; ?>"
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="images/<?php echo $bien['photo_2']; ?>"
                                            alt="Image Description">
                                    </div>
                                    <!-- End Card -->
                                </div>
                                <!-- End Col -->
                                 ...
                                 <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="images/<?php echo $bien['photo_3']; ?>"
                                            alt="Image Description">
                                    </div>
                                    <!-- End Card -->
                                </div>
                                <!-- End Col -->
                                 ...
                                 <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="images/<?php echo $bien['photo_localisation']; ?>"
                                            alt="Image Description">
                                    </div>
                                    <!-- End Card -->
                                </div>
                            ...
                            <form action="" method="">
                                 <!-- Form -->
                                <div class="mb-4">
                                    <label for="productNameLabel" class="form-label">Status <i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top"
                                            title="Products are the goods or services you sell."></i></label>
                                ...
                                <!-- Form -->
                                <div class="mb-4">
                                    <label for="productNameLabel" class="form-label">Premier versement <i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top"
                                            title="Products are the goods or services you sell."></i></label>

                                    <input type="text" class="form-control" name="premier" id="productNameLabel"
                                         aria-label="Shirt, t-shirts, etc." value="<?php echo $client['premier_versement']; ?>" 
                                        value="Tiro track jacket">
                                </div>
                                <!-- End Form -->
                                <!-- Form -->
                                <div class="mb-4">
                                    <label for="productNameLabel" class="form-label">Montant conclut <i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top"
                                            title="Products are the goods or services you sell."></i></label>

                                    <input type="text" class="form-control" name="montant" id="productNameLabel"
                                         aria-label="Shirt, t-shirts, etc." value="<?php echo $client['prix_conclut']; ?>" 
                                        value="Tiro track jacket">
                                </div>
                                <!-- End Form -->
                                <br><br>
                                <button type="submit" class="btn btn-primary" name="update">Enregister</button>
                            </form>
                        </div>
                        <!-- Body -->
                    </div>
    ...
    <!-- Embed Video Modal -->
    <div class="modal fade" id="embedVideoModal" tabindex="-1" aria-labelledby="embedVideoModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Header -->
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-4">
                            ...
                            <p>Use this feature when you want to put a product on sale or show savings off suggested
                                retail pricing.</p>
                        </div>
                    </div>
                    <!-- End Media -->
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 mb-3 mb-sm-0">
                            <img class="avatar avatar-lg avatar-4x3" src="assets/svg/illustrations/oc-discount.svg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="avatar avatar-lg avatar-4x3"
                                src="assets/svg/illustrations-light/oc-discount.svg" alt="Image Description"
                                data-hs-theme-appearance="dark">
                        </div>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Nov 2022 20:59:39 GMT -->
