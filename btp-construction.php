...
$request_btp = "SELECT * FROM btp";
$query_btp = mysqli_query($immo, $request_btp);
...
<head>
    ...
    <!-- Title -->
    <title>BTP - Construction | Pannel</title>
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item active" aria-current="page">Service construction</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Service BTP - Construction</h1>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                        ...
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control"
                                    placeholder="Rechercher un bon" aria-label="Search users">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Nom et prénom</th>
                                <th>Telephone</th>
                                <th>Lieu de construction</th>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="#">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0"><?php echo $value['nom']." ".$value['prenom']; ?> <i
                                                    class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Top endorsed"></i></span>
                                            <span class="d-block fs-5 text-body">service btp - construction</span>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <span class="d-block h5 mb-0"><?php echo $value['telephone']; ?></span>
                                    
                                </td>
                                <td><?php echo $value['lieu_construction']; ?></td>
                                <td>
                                    <span class="legend-indicator bg-success"></span><?php echo $value['date_demarrage']; ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fs-5 me-2"><?php echo $value['status']; ?></span>
                                    </div>
                                </td>
                                <td><?php echo $value['date_publication']; ?></td>
                                <td><a href="details-btp.php?details=<?php echo $value['id']; ?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
