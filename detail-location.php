...
if (isset($_GET['details'])) {
    ...
    /*get infos about bon*/
    $request_details = "SELECT * FROM location_panneau  WHERE id = '$details'";
    $query_details = mysqli_query($immo, $request_details);
    $location = mysqli_fetch_assoc($query_details);

    $code = $location['code_panneau'];
    $request_panneau = "SELECT * FROM panneau WHERE code_panneau  = '$code'";
    $query_panneau = mysqli_query($immo, $request_panneau);
    $panneau = mysqli_fetch_assoc($query_panneau);

}else {
    header('Location: location-panneau.php');
    exit();
}
...
<head>
    ...
    <!-- Title -->
    <title> Détail location | Pannel</title>
                    ...
                    <div id="addUserStepProfile" class="card card-lg active">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code"  aria-label="Code du bien" value="<?php echo $location['nom']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    aria-label="Code du bien" value="<?php echo $location['prenom']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="commune" id="commune"
                                        value="<?php echo $location['telephone'] ?>" aria-label="Commune" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="arrondissement" class="col-sm-3 col-form-label form-label">Code panneau</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="arrondissement" id="arrondissement"
                                         aria-label="Arrondissement" value="<?php echo $location['code_panneau']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="ville" class="col-sm-3 col-form-label form-label">Prix de location par jour</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ville" id="ville"
                                        aria-label="Ville" value="<?php echo $panneau['prix_jour']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Description</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $panneau['description']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Date de demarrage</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $location['date_debut']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
                             <!-- Form -->
                            <div class="row mb-4">
                                <label for="superficie" class="col-sm-3 col-form-label form-label">Date de fin</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="superficie" id="superficie"
                                         aria-label="Superficie" value="<?php echo $location['date_fin']; ?>" disabled>
                                </div>
                            </div>
                            <!-- End Form -->
